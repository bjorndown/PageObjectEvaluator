...
public class EvaluationConfig {
    ...
    public static EvaluationConfig from(PageObjectRunConfig runConfig) {
        return new EvaluationConfig(runConfig.getRunClass(), getModuleOutputPath(runConfig), new HtmlFileProvider().buildFromPastedHtml());
    }
    ...
    private static String getModuleOutputPath(PageObjectRunConfig runConfig) {
        ...
        return "file://" + CompilerPaths.getModuleOutputPath(module, false);
    }
